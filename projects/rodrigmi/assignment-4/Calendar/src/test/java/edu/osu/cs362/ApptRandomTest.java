...
public class ApptRandomTest {
	...
	//			System.out.println(" Seed:"+randomseed );
				...
				for (int i = 0; i < NUM_TESTS; i++) {
				 ...
				 int startMonth=ValuesGenerator.getRandomIntBetween(random,-10,22);
				 ...
				 Appt appt = new Appt(startHour,
					...
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("isValid")){					   	   				
						   ...
						   String ranstring = ValuesGenerator.getRandomIntBetween(random,0,10)==5 ? "Quavo":null;
						   String rantitle = ValuesGenerator.getRandomIntBetween(random,0,10)==5 ? "Offset":null;
						   appt.setDescription(ranstring);
						   appt.setTitle(rantitle);	
						}
